...
void get_rpm(){
  ...
  get_encoder();
  rpm[0] = ((encoder_posicao[0]-encoder_posicao_anterior[0])/tempo_contagem)/61440000;
  rpm[1] = ((encoder_posicao[1]-encoder_posicao_anterior[1])/tempo_contagem)/61440000;
  rpm[2] = ((encoder_posicao[2]-encoder_posicao_anterior[2])/tempo_contagem)/61440000;
  rpm[3] = ((encoder_posicao[3]-encoder_posicao_anterior[3])/tempo_contagem)/61440000;
}
